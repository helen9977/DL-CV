...
class Network (object):
    ...
    def __init__(self, sizes):
        ...
        self.size = sizes
        self.biases = [np.random.randn(y, 1) for y in sizes[1:]]  # 高斯分布
    ...
    def update_mini_batch(self,mini_batch,eta):
        ...
        self.biases = [b - (eta/len(mini_batch)) * nb for b, nb in zip(self.biases, nabla_b)]  # 梯度下降法更新偏置
